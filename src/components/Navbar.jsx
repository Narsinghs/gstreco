    ...
    <div className="bg-[f8f9fa] p-4 transform scale-105 relative z-10" style={{ backgroundColor: "#f8f9fa" }}     >
      <div className="max-w-[1400px] mx-auto flex  justify-between items-center relative z-20">
        <div className="flex items-center">
          ...
          <ul
            className={`md:flex space-x-9 items-center hidden md:flex ml-8 ${
...
>
            ...
            <li className="relative">
              ...
              {showDropdown === "home" && (
                <ul className="absolute left-0 mt-2 w-30 bg-black text-white shadow-lg rounded-lg z-30">
                  <li>
                    <ScrollLink
                      to="about"
                      smooth={true}
            ...
            <li className="relative">
              ...
              {showDropdown === "products" && (
                <ul className="absolute left-0 mt-2 w-40 bg-black shadow-lg rounded-lg z-30">
                  <li>
                    <RouterLink
          ...
          <ul className="flex flex-col mt-4 ">
            ...
            <li>
              ...
              <RouterLink to="/gst-reconciliation">
                <button className="hover:font-bold">Gst Reco</button>
              </RouterLink>
            </li>
                  {/* <li>
                    <RouterLink
